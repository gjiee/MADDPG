...
def run():
    ...
    memory = MultiAgentReplayBuffer(400_000, critic_dims, actor_dims,
                                    n_actions, n_agents, batch_size=1024)

    EVAL_INTERVAL = 20  # 每隔 10 步进行评估
    ...
    np.save('../data/kmeans_maddpg_scores.npy', np.array(eval_scores))
    np.save('../data/kmeans_maddpg_steps.npy', np.array(eval_steps))
