...
UAV_COVERAGE_ANGLE = 90    # 覆盖角度，单位：度
MIN_HEIGHT = 100  # 最小飞行高度，单位：米
MAX_HEIGHT = 300  # 最大飞行高度，单位：米
INITIAL_HEIGHT = 150  # UAV 初始飞行高度，单位：米

K = 10
CMAX = 20  # UAV 最大可服务节点数量
CMIN = 15  # UAV 最小可服务节点数量
MAX_DEVICES = 50
MAX_DEVICES_KMEANS = 30
MAX_DEVICES_RANDOM = 40

MIN_ALLOCATION_THRESHOLD = 0.05  # 最小资源分配阈值
